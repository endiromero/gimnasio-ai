		...
		btnGuardar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (txtTituloDeporte.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Por favor ingrese el titulo");
				...
				if (id == -1)
					AreaAdministracion.getInstancia().agregarDeporte(txtTituloDeporte.getText(),
							txtDescripcion.getText());
				else {
					try {
						AreaAdministracion.getInstancia().modificarDeporte(entidad.getIdDeporte(),
								txtTituloDeporte.getText(), txtDescripcion.getText());
					} catch (Exception e1) {
