...
public class Administrativo extends Empleado {
	...
	public Administrativo(String nombre, String telefono, String mail, String puesto, float bruto, float obraSocial,
			float retenciones) {
	...
	public Administrativo(int idEmpleado, String nombre, String telefono, String mail, String puesto, float bruto,
			float obraSocial, float retenciones) {
