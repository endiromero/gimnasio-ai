...
public class PoolConnection {
	...
	private Connection connect() {
		try {
			...
			// Connection con = DriverManager.getConnection (dbConnectString, usuario,
			// password);

			Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
			String dbConnectString = jdbc + servidor + "database=" + database + "integratedSecurity ="
					+ integratedSecurity;
	...
	public void getConfiguration() {
		...
		try {
			...
			integratedSecurity = propiedades.getProperty("integratedSecurity");
