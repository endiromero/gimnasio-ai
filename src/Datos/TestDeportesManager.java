...
public class TestDeportesManager implements DeportesManager {
	...
	public List<Deporte> getAllDeportes() {
		...
		for (Deporte currentDeporte : deportesBackingList) {
			result.add(new Deporte(
				currentDeporte.getIdDeporte(),
				currentDeporte.getTitulo(),
	...
	public void addDeporte(Deporte newDeporte) {
		...
		deportesBackingList.add(new Deporte(
				newDeporte.getIdDeporte(),
				newDeporte.getTitulo(),
				newDeporte.getDescripcion()
			));
	}
